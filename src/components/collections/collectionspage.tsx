...
const categories: Category[] = [
  {
    id: 1,
    icon: <Sofa className="w-8 h-8 text-[#3d5a4f]" strokeWidth={1.5} />,
    title: 'Living Room',
  ...
  {
    id: 2,
    icon: <Bed className="w-8 h-8 text-[#3d5a4f]" strokeWidth={1.5} />,
    title: 'Bedroom',
  ...
  {
    id: 3,
    icon: <Lamp className="w-8 h-8 text-[#3d5a4f]" strokeWidth={1.5} />,
    title: 'Lighting',
  ...
  {
    id: 4,
    icon: <House className="w-8 h-8 text-[#3d5a4f]" strokeWidth={1.5} />,
    title: 'Decor',
          ...
          {categories.map((category) => (
            ...
            >
              ...
              <div className="flex justify-center mb-6">
                <div className="w-20 h-20 bg-[#e8ebe9] rounded-full flex items-center justify-center group-hover:bg-[#d8dbd9] transition-colors duration-300">
                  {category.icon}
                </div>
              </div>
